...
export function Sidebar({ className, user, workspace }: SidebarProps) {
  ...
  async function onLogout() {
    try {
      ...
      // Ignore redirect "errors" as they are expected from Next.js actions
              ...
              {navItems.map((item) => {
                  ...
                  return (
                    <Tooltip key={item.name}>
                      <TooltipTrigger className="w-full">
                        <div className="group flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium text-white/10 transition-all cursor-not-allowed">
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    className={cn(
                      "group flex items-center justify-between rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-300 relative",
                        isActive 
