  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
      ...
      <button
        ...
        className="flex flex-col items-center justify-center p-8 rounded-[32px] border-2 border-dashed border-white/5 hover:border-[#6c47ff]/50 bg-white/[0.02] hover:bg-[#6c47ff]/5 transition-all duration-500 group"
      >
        ...
        <DialogContent className="bg-[#0b0b14] border-white/10 text-white rounded-[40px] max-w-md p-8">
          ...
          <DialogFooter>
            <Button
              ...
              className="w-full h-14 bg-[#6c47ff] hover:bg-[#5b3ce0] text-white font-black italic uppercase rounded-2xl shadow-lg shadow-[#6c47ff]/20"
            >
              {isSubmitting ? (
      ...
      {calendars.map((calendar) => (
        ...
        >
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-xl font-bold mt-4 text-white uppercase italic tracking-tighter">
              {calendar.name}
            </CardTitle>
